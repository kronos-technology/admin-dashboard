...
export const getVehicles = createAsyncThunk('admin/vehicles', async () => {
...
export const { setTableData, setVehiclesList, setFilterData } = dataSlice.actions;
